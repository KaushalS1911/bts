        ...
        <div className="bg-[#1a1818] text-white px-4 pt-16 md:px-8 lg:px-24">
            <div className="container mx-auto ">
                <div
                    ...
                    className="inline-flex items-center gap-2 bg-[#F6F6F6] text-[#0C1A3B] text-[14px] font-medium leading-[14px] tracking-[0em] px-4 py-2 rounded-lg shadow-sm cursor-pointer w-fit mb-2">
                ...
                <div className="flex flex-col xl:grid xl:grid-cols-[2fr_1fr] gap-10">
                    <div>
                        ...
                        <div className="relative rounded-lg overflow-hidden">
                            ...
                            <div className="absolute bottom-0 inset-x-0">
                                <div
                                    className="backdrop-blur-sm bg-black/30 md:bg-transparent rounded-t-md px-4 py-3 md:p-6">
                                    <div
                                        className="bg-[#DEE8FF] inline-flex items-center gap-2 px-4 py-1 rounded-full text-sm font-medium text-[#0C1A3B] mb-3 md:mb-4">
                                    ...
                                    <p className="font-normal text-[13px] md:text-[14px] leading-[100%] tracking-[0] text-gray-300">
                        ...
                        <div className="mt-10 space-y-6">
                            {blogData.contentSections.map((section, idx) => (
                                <div key={idx}>
                                    <h2 className="text-[#fff] text-[27px] font-bold leading-[130%] tracking-[0] mb-5 mt-10">
                                        {section.heading}
                                    </h2>

                                    {/* Show section image if available */}
                                    {section.image && (
                                        <div className="mb-4">
                                            <Image
                                                src={section.image}
                        ...
                        <div
                            className="mt-10 bg-gradient-to-r from-[#A2390D] to-[#BD4B1A] rounded-lg p-5 flex items-center justify-between flex-wrap gap-4">
                            <p className="text-white text-base font-semibold leading-[100%] tracking-[0]">
                            ...
                            <div className="flex gap-4">
                                ...
                                <Image src={img6} alt="LinkedIn" width={24} height={24}
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-[#A2390D] text-white rounded-xl p-6 sm:p-8">
                            ...
                            <h3 className="text-[20px] font-semibold leading-[100%] tracking-[0%] mb-5">{author.name}</h3>
                            <p className="text-[20px] leading-[130%] tracking-[0%] font-normal text-white mb-4">{author.title}</p>
                            <hr className="border border-white/20 mb-4"/>
                            <p className="text-[14px] leading-[18px] tracking-[0%] text-white/90">{author.description}</p>
                        </div>

                        {/* Share Icons */}
                        <div className="bg-[#A2390D] p-6 rounded-xl space-y-3">
                            <p className="font-semibold text-[16px] leading-[100%] tracking-[0%]">
                                Share with your community!
                            </p>
                            <div className="flex space-x-4">
                                {socialIcons.map((icon, idx) => (
                                    <Image key={idx} src={icon.src} alt={icon.alt} width={30} height={30}
                        ...
                        <div className="py-6">
                            <h4 className="text-white font-semibold text-[20px] leading-[20px] tracking-[0px] mb-6">
                                In this article
                            </h4>
                            <ul className="space-y-4 text-[15px] leading-[22px]">
                                {blogData.sectionsList.map((item, idx) => (
                                    <li
                                        key={idx}
                                        className={`break-words ${
                                            idx === 0 
                                                ? 'pl-3 border-l-2 border-orange-500 text-orange-400 font-semibold text-[16px] leading-[16px] tracking-[0px] mb-6'
                                                : 'text-white ml-3.5 font-normal text-[16px] leading-[16px] tracking-[0px] mb-6'
                                        }`}
                                    >
                                        {item}
                                    </li>
