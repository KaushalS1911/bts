...
function WhyWorkWithUs() {
    const features: Feature[] = [
        {
            icon: (
                <svg className="w-[53px] h-[89px] text-orange-500" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="bg-[#1A1818] py-20 px-4 sm:px-6 lg:px-8">
            <div className="max-w-6xl container mx-auto">
                <div className="text-center mb-16">
                    <h2 className="text-[32px] sm:text-[40px] md:text-[44px] lg:text-[48px] font-bold text-white mb-13 leading-tight text-center">
                        Why Work With Us?
                    </h2>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
                    {features.map((feature, index) => (
                        <div
                            key={index}
                            className="bg-[#101010] rounded-lg p-7 lg:p-10 hover:bg-gray-750 transition-colors duration-300 flex flex-col h-full"
                        >
