...
const ProjectShowcase: React.FC = () => {
    ...
    return (
        <section className="bg-[#1A1818] text-white py-12 px-4 sm:px-6 lg:px-12">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 max-w-6xl mx-auto">
                {projects.map((project, index) => (
                    <div key={index} className="space-y-4">
                        ...
                        <div>
                            <div
                                className="text-[24px] sm:text-[28px] md:text-[32px] font-bold text-white cursor-pointer"
                            ...
                            <div className="mt-1 text-sm text-gray-400">
                                <p>
                                    <span className="font-normal text-[#606060] md:text-[18px] text-[16px]">Client:</span>{" "}
                                    <span className="md:text-[18px] text-[16px] font-normal text-white">{project.client}</span>
                                </p>
                                <p>
                                    <span className="font-normal text-[#606060] md:text-[18px] text-[16px]">Work:</span>{" "}
                                    <span className="md:text-[18px] text-[16px] font-normal text-white">{project.work}</span>
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            {/* CTA */}
            <div className="mt-16 bg-gray-900 rounded-2xl py-15 px-6 sm:px-12 max-w-6xl mx-auto text-white">
