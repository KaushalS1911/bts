...
const IndustriesWeServe: React.FC = () => {
    return (
        <div className="relative bg-[#1A1818] text-white py-6 sm:py-8 md:py-12 lg:py-16 px-3 sm:px-4 md:px-6">
            ...
            <div className="hidden lg:flex flex-col items-center max-w-6xl mx-auto">
                <div className="bg-[#2A2A2A] rounded-2xl p-4 mb-8 relative z-10 border">
                    <div className=" rounded-2xl flex items-center justify-center px-3">
                        <Image src={'/assets/images/logo2.png'} alt={'logo'} height={93} width={122} />
                    </div>
                </div>
