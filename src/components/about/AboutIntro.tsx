...
const AboutIntro = () => {
    return (
        <section className="bg-[#1A1818] py-20 px-4 text-white">
            ...
            <div className="container mx-auto flex flex-col lg:flex-row items-center lg:items-start justify-between gap-12">
                {/* Left - Thumbnail + Play */}
                ...
                {/* Right - Paragraphs */}
                <div className="max-w-2xl w-full text-center lg:text-left space-y-5 text-[16px] sm:text-[17px] md:text-[18px] leading-relaxed font-normal">
                    <p>
